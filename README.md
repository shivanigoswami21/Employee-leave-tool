# Employee Leave Tool
Employee leave tool is a camunda-based application that allows the manager/HR to approve/reject leaves requested by the employees.
...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/org/nsn/eleave/ProcessTest.java) in your IDE or using:
...
<!-- Tweet
New @Camunda example: Camunda Platform Process Application - A Process Application for [Camunda Platform](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/eleave
-->
